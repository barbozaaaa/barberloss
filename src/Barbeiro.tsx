...
const servicos: {
  ...
  { id: 'corte', nome: 'Corte de cabelo premium', icone: '✂️', preco: 55 },
  { id: 'barba', nome: 'Barba desenhada', icone: '🧔', preco: 40 },
